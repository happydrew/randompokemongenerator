...
function expandMoreShowOptions() {
...
function collapseMoreShowOptions() {
 ...
 * @returns 
 */
function getNumrangeOptions(numrangeId: string): string | undefined {
