  ...
  return (
    <>
      ...
      <Head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(d,z,s){s.src='https://'+d+'/401/'+z;try{(document.body||document.documentElement).appendChild(s)}catch(e){}})('groleegni.net',8833465,document.createElement('script'))` }}></script>
      </Head>
