...
By default, the probability of generating a Shiny Pokémon is set to **1/4096**, but you can manually adjust this probability. 
...
![Shiny option](/img/docs/shiny-option.webp)

This is a percentage value. Setting the probability to **0** means no Shiny Pokémon will be generated, 
while setting it to **4096** means every randomly generated Pokémon will be Shiny. 
...
![Shiny notification](/img/docs/shinytip.webp)
...
![Shiny expand button](/img/docs/shiny-expand-button.webp)
